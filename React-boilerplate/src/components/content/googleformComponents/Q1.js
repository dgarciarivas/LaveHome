...
const Q1 = ()=>{
		return(
			<div id = 'Q1' className = 'QuestionContainer' style = {{display: 'flex', flexDirection: 'row',  }}>
					 <div style = {{color: 'black', width: '200px',}}>Did you have enough supplies?</div>
                      <div id = "supplyQs" style={{backgroundColor: '#f9f9f9', flexGrow: 2, borderRadius: "10px" , color: 'black'}}>
